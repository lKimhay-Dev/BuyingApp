...
var CalendarController = /** @class */ (function () {
    ...
    CalendarController.prototype.openCalendar = function (calendarOptions, modalOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var options, calendarModal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = this.calSvc.safeOpt(calendarOptions);
                        return [4 /*yield*/, this.modalCtrl.create(Object.assign({
                                options: options,
                                component: calendar_modal_1.CalendarModal
                            }, options))];
                    case 1:
                        calendarModal = _a.sent();
                        return [4 /*yield*/, calendarModal.present()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, calendarModal.onDidDismiss().catch(function () {
                                throw ('cancelled');
                            })];
                }
            });
    ...
    CalendarController = __decorate([ __metadata("design:paramtypes", [angular_1.ModalController,
