...
function CalendarComponent_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("ngModelChange", function CalendarComponent_ng_template_5_Template_ion_calendar_month_ngModelChange_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); var ctx_r12 = ɵngcc0.ɵɵnextContext(); return ctx_r12._calendarMonthValue = $event; })("onChange", function CalendarComponent_ng_template_5_Template_ion_calendar_month_onChange_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); var ctx_r14 = ɵngcc0.ɵɵnextContext(); return ctx_r14.onChanged($event); })("swipe", function CalendarComponent_ng_template_5_Template_ion_calendar_month_swipe_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); var ctx_r15 = ɵngcc0.ɵɵnextContext(); return ctx_r15.swipeEvent($event); })("onSelect", function CalendarComponent_ng_template_5_Template_ion_calendar_month_onSelect_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); var ctx_r16 = ɵngcc0.ɵɵnextContext(); return ctx_r16.onSelect.emit($event); })("onSelectStart", function CalendarComponent_ng_template_5_Template_ion_calendar_month_onSelectStart_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); var ctx_r17 = ɵngcc0.ɵɵnextContext(); return ctx_r17.onSelectStart.emit($event); })("onSelectEnd", function CalendarComponent_ng_template_5_Template_ion_calendar_month_onSelectEnd_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); var ctx_r18 = ɵngcc0.ɵɵnextContext(); return ctx_r18.onSelectEnd.emit($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function CalendarComponent_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function CalendarComponent_ng_template_6_Template_ion_calendar_month_picker_onSelect_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); var ctx_r19 = ɵngcc0.ɵɵnextContext(); return ctx_r19.monthOnSelect($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
CalendarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarComponent, selectors: [["ion-calendar"]], inputs: { format: "format", type: "type", readonly: "readonly", options: "options" }, outputs: { onChange: "onChange", monthChange: "monthChange", onSelect: "onSelect", onSelectStart: "onSelectStart", onSelectEnd: "onSelectEnd" }, features: [ɵngcc0.ɵɵProvidersFeature([exports.ION_CAL_VALUE_ACCESSOR])], decls: 8, vars: 5, consts: [[1, "title"], [3, "ngIf", "ngIfElse"], ["title", ""], [3, "ngIf"], ["monthPicker", ""], ["type", "button", "fill", "clear", 1, "switch-btn", 3, "click"], [1, "arrow-dropdown", 3, "name"], [1, "switch-btn"], ["type", "button", "fill", "clear", 1, "back", 3, "disabled", "click"], ["name", "ios-arrow-back"], ["type", "button", "fill", "clear", 1, "forward", 3, "disabled", "click"], ["name", "ios-arrow-forward"], ["color", "transparent", 3, "weekArray", "weekStart"], [1, "component-mode", 3, "ngModel", "month", "readonly", "pickMode", "color", "ngModelChange", "onChange", "swipe", "onSelect", "onSelectStart", "onSelectEnd"], [3, "color", "monthFormat", "month", "onSelect"]], template: function CalendarComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.NgIf, ɵngcc2.IonButton, ɵngcc2.IonIcon, ɵngcc3.CalendarWeekComponent, ɵngcc4.MonthComponent, ɵngcc5.NgControlStatus, ɵngcc5.NgModel, ɵngcc6.MonthPickerComponent], encapsulation: 2 });
