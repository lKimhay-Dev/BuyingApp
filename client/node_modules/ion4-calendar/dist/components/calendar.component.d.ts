...
export declare class CalendarComponent implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<CalendarComponent, "ion-calendar", never, { "format": "format"; "type": "type"; "readonly": "readonly"; "options": "options"; }, { "onChange": "onChange"; "monthChange": "monthChange"; "onSelect": "onSelect"; "onSelectStart": "onSelectStart"; "onSelectEnd": "onSelectEnd"; }, never, never>;
}
