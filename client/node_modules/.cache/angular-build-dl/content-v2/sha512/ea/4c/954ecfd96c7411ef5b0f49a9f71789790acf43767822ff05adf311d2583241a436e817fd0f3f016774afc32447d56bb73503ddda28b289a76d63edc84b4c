(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-retailer-register-retailer-module"], {
    ...
    function srcAppHomeRegisterRetailerRegisterRetailerPageScss(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".arow-back {\n  font-size: 25px;\n  font-weight: bold;\n}\n\nion-title.info {\n  font-size: 18px;\n  font-weight: bold;\n  color: #4848f1;\n  width: 234px;\n  height: 27px;\n  letter-spacing: -0.36px;\n}\n\nion-label.info {\n  font-size: 14px;\n  color: #4848f1;\n  letter-spacing: -0.28px;\n  width: 255px;\n  height: 21px;\n}\n\n.btn {\n  height: 35px;\n  width: 100px;\n  letter-spacing: -0.28px;\n  font-size: 14px;\n  width: 103px;\n  height: 48px;\n}\n\n.btn-size {\n  margin-top: 16em;\n  letter-spacing: -0.28px;\n  font-size: 14px;\n  height: 48px;\n}\n\n.lable-size {\n  font-size: 16px;\n  letter-spacing: -0.32px;\n  width: 44px;\n  height: 24px;\n}\n\n.txtsize {\n  font-size: 14px;\n  letter-spacing: -0.28px;\n  width: 26px;\n  height: 21px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
      ...
      var RegisterRetailerPage = /*#__PURE__*/function () {
        ...
        _createClass(RegisterRetailerPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParams.subscribe(function (params) {
              _this2.user = params["user"];
              _this2.area = params["area"];
          ...
          value: function addRetailHandler() {
            ...
            this.dataFee.create_date = new Date(); // Data Create User
            ...
            this.depositorService.createDepo(deposNames).subscribe(function (depos) {
              ...
              _this3.retailerService.createRetailer(_this3.data).subscribe(function (res) {
                _this3.buyingFeeService.createBuyingFee(_this3.dataFee).subscribe(function (res) {
                  _this3.userService.createUser(_this3.dataUser).subscribe(function (res) {
                    console.log(res);
                    localStorage.setItem('userData', _this3.user || '{}');
