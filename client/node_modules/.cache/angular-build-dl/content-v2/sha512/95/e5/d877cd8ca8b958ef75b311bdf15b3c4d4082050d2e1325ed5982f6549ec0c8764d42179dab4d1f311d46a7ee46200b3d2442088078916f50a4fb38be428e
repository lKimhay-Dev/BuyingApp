...
const routes = [
    ...
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | menu-page-menu-page-module */ "menu-page-menu-page-module").then(__webpack_require__.bind(null, /*! ./menu-page/menu-page.module */ "./src/app/menu-page/menu-page.module.ts")).then(m => m.MenuPagePageModule)
    },
    {
        path: 'login',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | sign-up-select-region-select-region-module */[__webpack_require__.e("common"), __webpack_require__.e("sign-up-select-region-select-region-module")]).then(__webpack_require__.bind(null, /*! ./sign-up/select-region/select-region.module */ "./src/app/sign-up/select-region/select-region.module.ts")).then(m => m.SelectRegionPageModule)
    }
];
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"],
            _angular_fire__WEBPACK_IMPORTED_MODULE_11__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].firebaseConfig),
...
const environment = {
    ...
    firebaseConfig: {
        ...
        projectId: "sociallogin-301704",
        storageBucket: "sociallogin-301704.appspot.com",
        messagingSenderId: "916958793295",
        appId: "1:916958793295:web:a9d4de57a2b699f2b2a43a",
        measurementId: "G-3YK9WXL96T"
    }
};
/*
...
module.exports = __webpack_require__(/*! /home/kimhay/Devs/SVN/Ionic/BuyingApp/client/src/main.ts */"./src/main.ts");
