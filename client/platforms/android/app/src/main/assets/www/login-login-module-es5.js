(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function srcAppLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! ./login.page */
      "./src/app/login/login.page.ts"); // import { GooglePlus } from '@ionic-native/google-plus/ngx';
    ...
    function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(google, loadingController, fireAuth, platform, navCtrl) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function doLogin() {
            ...
            var params;
            this.fireAuth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"].GoogleAuthProvider()).then(function (success) {
              console.log('success in google login');
              _this.user = success.user; // Save user data to Local Storage
              ...
              _this.navCtrl.navigateForward(['sign-up'], navigationExtras);
            })["catch"](function (err) {
