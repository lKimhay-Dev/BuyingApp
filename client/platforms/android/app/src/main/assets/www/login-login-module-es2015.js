...
let LoginPage = class LoginPage {
    constructor(google, loadingController, fireAuth, platform, navCtrl) {
        this.google = google;
    ...
    doLogin() {
        let params;
        this.fireAuth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"].GoogleAuthProvider()).then(success => {
