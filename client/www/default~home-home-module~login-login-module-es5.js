    ...
    function srcAppServiceAuthAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(httpClient) {
          ...
          this.base_path = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].api + 'authenticate';
          this.httpOptions = {
        ...
        _createClass(AuthService, [{
          ...
          value: function authenticate(token) {
            return this.httpClient.post(this.base_path, {
              token: token
            }, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorResponse));
          }
        }, {
          key: "setLocalStorage",
          value: function setLocalStorage(data) {
            var expiresAt = moment__WEBPACK_IMPORTED_MODULE_5___default()().add(data.expires[0], data.expires[1]);
          ...
          value: function isLoggedIn() {
            return moment__WEBPACK_IMPORTED_MODULE_5___default()().isBefore(this.getExpiration());
          }
        }, {
          key: "isLoggedOut",
          ...
          value: function getExpiration() {
            ...
            return moment__WEBPACK_IMPORTED_MODULE_5___default()(expiresAt);
          }
        }, {
          key: "errorResponse",
          value: function errorResponse(error) {
            console.log(error);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])("".concat(error.statusText));
          }
        }]);
...
//# sourceMappingURL=default~home-home-module~login-login-module-es5.js.map